...
b. The compiler assigned values to the variables. What are these values called?
	Answer: 0 for int, "blank space" for string and false for bool
...
func main() {
	fmt.Println("----- Ninja Level 1 ----- Coding Exercise #2 -----")

	fmt.Println(x, y, z)
	fmt.Println("Output:", x, y, z)
	fmt.Printf("x -> %d, y -> %s, z -> %t", x, y, z)
